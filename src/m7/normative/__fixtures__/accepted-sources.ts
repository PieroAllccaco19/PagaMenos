// Test fixture: the accepted M7 V1.1, Erratum 01 and Erratum 02 bytes as committed in the repository, and a helper
// that applies line-level mutations to COPIES of them (negative controls never touch the files).
import { readFileSync } from 'node:fs';
import { join } from 'node:path';

import { M7_V1_1, M7_V1_1_ERRATUM_01, M7_V1_1_ERRATUM_02 } from '../source';
