...
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_02.md` (blob `a0e6fa6720f23ac08485ab7cb696ab9ba4b7e83f`) and
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_03.md` (blob `8ba87adc9b87cee749c214d9326b0aa750ceabf0`).
Conformance target: **M7 V1.1 + accepted Erratum 01 + accepted Erratum 02 + accepted Erratum 03**.
