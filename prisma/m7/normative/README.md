...
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_01.md` (blob `15ee22090d3e37b6a63dd25914f8abb0f4fa9d4b`) and
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_02.md` (blob `a0e6fa6720f23ac08485ab7cb696ab9ba4b7e83f`).
Conformance target: **M7 V1.1 + accepted Erratum 01 + accepted Erratum 02**.
