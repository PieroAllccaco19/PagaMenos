...
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_03.md` (blob `8ba87adc9b87cee749c214d9326b0aa750ceabf0`),
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_04.md` (blob `c839db3948608c875c984a73e366c039c0a5e2dd`) and
`PAGAMENOS_M7_OUTCOME_EVIDENCE_EFFECTIVE_SPEC_V1_1_ERRATUM_05.md` (blob `49651e77f24538f9122c9173f2d0201823d61366`):
six accepted authority documents.
Conformance target: **M7 V1.1 + accepted Erratum 01 + accepted Erratum 02 + accepted Erratum 03 + accepted Erratum 04 + accepted Erratum 05**.
